...
func NewGoogleProcessor(outputs *common.Outputs, observability *common.Observability) *GoogleProcessor {
	...
	return &GoogleProcessor{
		...
		requests: observability.Metrics().Counter("google", "requests", "Count of all google processor requests", map[string]string{}, "processor"),
		errors:   observability.Metrics().Counter("google", "errors", "Count of all google processor errors", map[string]string{}, "processor"),
	}
}
